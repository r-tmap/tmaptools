...
#' \code{\link{palette_explorer}}\tab Interactive tool to explor Color Brewer palettes \cr
#' --------------------------- \tab --------------------------------------------------------------------------------------------------- \cr
#' }
#'
#' @section Transform shapes (statistical transformation):
#' \tabular{ll}{
