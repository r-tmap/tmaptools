...
#' @param unit the preferred unit, see \code{\link{approx_areas}}. Density values are calculated in \code{var/unit^2}.
#' @param coords.unit unit by which the coordinates are defined, see \code{\link{approx_areas}}.
#' @param unit.size size of the target unit (specified by \code{unit}) in terms of the coordinate units (specified by \code{coords.unit}), see \code{\link{approx_areas}}.
...
#' @export
calc_densities <- function(shp, var, unit="metric", coords.unit=NA, unit.size=NA, total.area=NA, suffix="", drop=TRUE) {
	## calculate densities
