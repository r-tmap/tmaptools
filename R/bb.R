...
#' \itemize{
#' \item A shape (from class \code{\link[sf:sf]{sf}} (simple features)), \code{\link[stars:st_as_stars]{stars}}, \code{\link[sp:Spatial]{Spatial}}, \code{\link[raster:Raster-class]{Raster}}.
#' \item A bounding box (\code{\link[sf:st_bbox]{st_bbox}}, \code{\link[raster:Extent]{Extent}}, numeric vector of 4 (default order: xmin, ymin, xmax, ymax), or a 2x2 matrix).
